...
export default function GraphComponent({
  ...
  const [selectedYearRange, setSelectedYearRange] = useState(defaultYearRange || [1800, 2023]);
  const [availableYears, setAvailableYears] = useState([1800, 2023]);
  const [selectedRegion, setSelectedRegion] = useState(defaultRegion || 'World');
